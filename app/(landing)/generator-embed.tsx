    ...
    <div className="w-full">
      ...
      <Tabs defaultValue="flashcards">
        <TabsList className="mb-5 bg-[#eef0ff] p-1 rounded-xl h-auto w-full">
          <TabsTrigger value="flashcards" className="flex-1 gap-1.5 rounded-lg data-[state=active]:!bg-[#4255ff] data-[state=active]:shadow-md data-[state=active]:!text-white !text-[#4a5096] font-semibold px-3 py-2 text-sm">
            <BookOpen size={14} />Flashcards ({result.flashcards.length})
          </TabsTrigger>
          <TabsTrigger value="quiz" className="flex-1 gap-1.5 rounded-lg data-[state=active]:!bg-[#4255ff] data-[state=active]:shadow-md data-[state=active]:!text-white !text-[#4a5096] font-semibold px-3 py-2 text-sm">
    ...
    <div className="w-full space-y-4">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-4 bg-[#eef0ff] p-1 rounded-xl h-auto w-full">
          <TabsTrigger value="document" className="flex-1 gap-2 rounded-lg data-[state=active]:!bg-[#4255ff] data-[state=active]:shadow-md data-[state=active]:!text-white !text-[#4a5096] font-semibold px-3 py-2.5">
            <FileText size={15} />Document
          </TabsTrigger>
          <TabsTrigger value="media" className="flex-1 gap-1.5 rounded-lg data-[state=active]:!bg-[#4255ff] data-[state=active]:shadow-md data-[state=active]:!text-white !text-[#4a5096] font-semibold px-3 py-2.5">
