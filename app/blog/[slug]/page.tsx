...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const blogPostingSchema = {
    ...
    url: `https://quizeagle.com/blog/${slug}`,
    image: `https://quizeagle.com/blog/${slug}/opengraph-image`,
    author: { "@type": "Organization", name: "Quiz Eagle", url: "https://quizeagle.com" },
    publisher: {
      "@type": "Organization",
      name: "Quiz Eagle",
      url: "https://quizeagle.com",
      logo: { "@type": "ImageObject", url: "https://quizeagle.com/favicon.ico" },
    },
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://quizeagle.com/blog/${slug}` },
  };
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://quizeagle.com" },
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://quizeagle.com/blog" },
      { "@type": "ListItem", position: 3, name: post.title, item: `https://quizeagle.com/blog/${slug}` },
    ],
  };
