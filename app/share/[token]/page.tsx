  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative" style={{ perspective: "1200px" }}>
        <div
          className={cn("relative w-full transition-transform duration-500 cursor-pointer transform-gpu")}
      ...
      <div className="bg-white rounded-2xl border border-[#ECEEF4] shadow-sm p-7">
        ...
        <div className="space-y-3">
          {question.options.map((opt, oi) => {
            ...
            return (
              <div key={oi} className={className} onClick={() => { if (!answered) setAnswers((a) => ({ ...a, [currentQ]: oi })); }}>
                <span className={cn(
